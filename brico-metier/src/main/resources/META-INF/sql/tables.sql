...
(
	...
	IDPOST_REF BIGINT DEFAULT 0 NOT NULL,
	THEME_ID SMALLINT,
	TITLE VARCHAR(100),
	POST VARCHAR(500),
	TYPE_POST SMALLINT,
	NB_VOTES BIGINT DEFAULT 0 NOT NULL,
	NOTE BIGINT DEFAULT 0 NOT NULL,
...
INSERT INTO KV01.POST(DATE_CREATION, THEME_ID, TITLE, POST, POST_VALIDATE, IDPOST_REF, IDUSER_CREATION, PSEUDO_USER_CREATION) VALUES('2015-02-14 12:15:00', '1', 'Qoqo', 'Post Test 8', 1, 0, 1, 'Diego');
...
INSERT INTO KV01.POST(DATE_CREATION, THEME_ID, TITLE, POST, POST_VALIDATE, IDPOST_REF, IDUSER_CREATION, PSEUDO_USER_CREATION) VALUES('2015-02-15 07:43:00', '1', 'Jojo', 'Post Test 10', 0, 0, 1, 'Diego');
